...
namespace CMS.Application.Exceptions
{
    public class ResponseMiddleware
    {
            ...
            else
            {
                ...
                using (var responseBody = new MemoryStream())
                {
                    ...
                    try
                    {
                        ...
                        //400 errors we rae handling by using filter
        ...
        public static Task  HandleSuccessRequestAsync(HttpContext context, object body,int code)
        {
        ...
        public static Task HandleNotSuccessRequestAsync(HttpContext context,int code)
        {
